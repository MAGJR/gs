          ...
          <div className="flex flex-col space-y-4 sm:flex-row sm:space-x-8 sm:space-y-0">
            ...
            <div className="flex-grow">
              <Slider {...settings} className="mt-8 w-full max-w-2xl">
                ...
                <div>
                  <Image src={Home} width={500} height={300} alt="Truck" className="rounded-lg object-cover" />
                </div>
                <div>
                  <Image src={Home} width={500} height={300} alt="Airplane" className="rounded-lg object-cover" />
                </div>
                <div>
                  <Image src={Home} width={500} height={300} alt="Ship" className="rounded-lg object-cover" />
                </div>
              </Slider>
            </div>
          </div>
