import { CardComponentDivisoriaCortina } from '@/app/components/card'
  ...
  const items: ItemsInfoProps[] = [
    {
      ...
      title: 'Light',
      description:
        'The lightest of the thermal dividers. It weighs only 7kg. It is synonymous with easy installation and handling.',
    },
    {
      id: 2,
      title: 'Convenience',
      description:
        'It is fixed by a pallet trailer for the vehicle, which is installed on the sides of the vehicle. Easy to install. Easy to remove.',
    },
    {
      id: 3,
      title: 'Customization',
      description:
        'Besides the size, we can also have it made with a central opening, zip or velcro, as well as install the ventilation kit, 12V or 24V.',
    },
    {
      id: 4,
      title: 'Optimization',
      description:
        'Because it does not have a structure, the thermal divider can be installed in larger or smaller vehicles, being adjusted only in the pallet trailer.',
    },
  ]
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center pt-5 mb-36">
        ...
        <Image width={400} src={divisoriaTermicaCortina} alt="Hero" />
      </div>

      <div className="flex items-start gap-5 mr-auto pl-8 pb-8">
        <Image
          src={divisoriaTermicaCortinaInfo}
          width={300}
          alt="teste"
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          <CardTitle>
            A THERMAL DIVIDER IS USED TO SEPARATE FROZEN, COOLED AND DRY GOODS
            IN REFRIGERATED VEHICLES. OPTIMIZE YOUR LOGISTICS BY TRANSPORTING
            MORE THAN ONE LOAD IN A VEHICLE.{' '}
          </CardTitle>
          <CardDescription className="mt-2">
            Typically used by distributors, who transport for a short time,
            usually completing the delivery within the same day. They are
            lightweight, without structure, attached to the roof through a
            bracket, and have a low cost. They can also be used for cargo
            protection during the wait for unloading.
          </CardDescription>
        </div>
      </div>
      ...
      <div className="flex gap-5 mr-auto pl-8 pt-8 items-center ml-8">
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          ...
          <CardDescription className="mt-2 mb-4">
            The purpose of increasing durability, making cleaning easier, and
            reducing weight is to work with the best materials in the thermal
            curtain composition. In the reinforcement, we use nylon, a
            easy-to-clean, waterproof, and light material, which ensures a long
            life to the product.
          </CardDescription>
          <CardDescription className="mt-2 mb-4">
            The internal thermal layers follow the same concept of lightness and
            durability, being joined by compression seams, guaranteeing a long
            life to the product.
          </CardDescription>
          {numbers
