import { CardComponentDivisoriaTermica } from '@/app/components/card'
...
export default function Page() {
  ...
  const items: ItemsInfoProps[] = [
    ...
    },
    {
      ...
      title: 'Reinforced',
      description:
        'Our thermal divider for freezer cabinet is the only one on the market with a thickness of 90mm. This means delivering a better and more resistant product.',
    },
    {
      id: 3,
      title: 'Customization',
      description:
        'All thermal dividers for trucks are manufactured to order to meet the specifications of your vehicle. Also, it can be manufactured with ventilation kit.',
    },
    {
      id: 4,
      title: 'Fuel Economy',
      description:
        'With the thermal divider for cabinet, the space that needs to be cooled is reduced, and consequently, the time the equipment needs to be turned on to maintain temperature. This represents a huge fuel savings.',
    },
  ]
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center pt-5 mb-36">
        ...
        <Image width={400} src={divisoriaTermicaBipartidafrom} alt="Hero" />
      </div>

      <div className="flex items-start gap-5 mr-auto pl-8 pb-8">
        <Image
          src={divisoriaTermicaBipartidaInfo}
          width={300}
          alt="teste"
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          <CardTitle>
            THE THERMAL DIVIDER IS USED TO SEPARATE FROZEN, COOLED AND DRY LOADS
            IN REFRIGERATED VEHICLES. OPTIMIZE YOUR LOGISTICS BY CARRYING MORE
      ...
      <div className="flex gap-5 mr-auto pl-8 pt-8 items-center ml-8">
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          ...
          <CardDescription className="mt-2 mb-8">
            Designed for separation of loads in refrigerated trucks. The robust
            structure is produced by the union of EPS and EPE panels, with
            lateral foam D28.
          </CardDescription>
          {numbers
