import { CardComponentGancheira } from '@/app/components/card'
  ...
  const items: ItemsInfoProps[] = [
    {
      ...
      description:
        'Every logistics operation that uses thermally insulated cabinet can optimize the use of their trucks and diversify their loads, improving the utilization of vehicles in each trip.',
    },
    {
      id: 2,
      title: 'Economy',
      description:
        'With the use of thermally insulated cabinet, the space that needs to be refrigerated is reduced, and with this, the use of the refrigeration device is reduced, resulting in operational cost reduction.',
    },
    {
      id: 3,
      title: 'Customization',
      description:
        'Each product is manufactured to fit the specific dimensions of the vehicle the cabinet will be used on.',
    },
    {
      id: 4,
      title: 'Lightweight',
      description:
        'Besides durability, the structure fabricated in aluminum also becomes lightweight and easy to handle.',
    },
  ]
    ...
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center mt-10 mb-36">
        <CardTitle className="mb-4">
          {' '}
          Insulated Partition for Gantries{' '}
        </CardTitle>
        <Image width={400} src={divisoriaTermicaGancheira} alt="Hero" />
      </div>

      <div className="flex items-start gap-5 mr-auto pl-8 pb-8">
        <Image
          src={divisoriaTermicaGancheiraInfo}
          width={300}
          alt="teste"
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          <CardTitle>
            THE THERMAL DIVIDER IS USED TO SEPARATE FROZEN, REFRIGERATED AND DRY
            GOODS IN REFRIGERATED TRUCKS. OPTIMIZE YOUR LOGISTICS BY CARRYING
            MORE THAN ONE LOAD IN A TRUCK.
          </CardTitle>
          <CardDescription className="mt-2">
            Made for use in conveyor belt gantry, with a movable part to be
            stored alongside the refrigeration equipment. Structured in
            aluminum, covered with 530-gram cloth, with reinforcement at the
            base with plastic. Custom-made.
          </CardDescription>
        </div>
      </div>
