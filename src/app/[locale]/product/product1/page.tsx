  ...
  const items: ItemsInfoProps[] = [
    {
      ...
      title: 'Efficiency',
      description:
        'Provides passive thermal protection of sensitive loads during all stages of the logistical cycle.',
    },
    {
      id: 2,
      title: 'Customization',
      description:
        'We manufacture sizes that meet your logistics operation, maximizing your results within your budget and need.',
    },
    {
      id: 3,
      title: 'Cost-Benefit',
      description:
        'The thermal sheet for pallets is a solution with excellent cost-benefit for load protection. Enjoy the security of an active system with low investment.',
    },
  ]
    ...
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center pt-5 mb-36">
        <CardTitle className="mb-4">
          Thermal Insulation Cover for Pallets
        </CardTitle>
        <Image src={coberturaTermicaMain} width={500} alt="Hero" />
      </div>
      ...
      <div className="flex items-start gap-5 mr-auto pl-8 pb-8">
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          <CardTitle className="">
            THERMAL LINING FOR PALLETIZED GOODS REQUIRING TEMPERATURE CONTROL
            DURING THE LOGISTICS PROCESS.
          </CardTitle>
          <CardDescription className="mt-2">
            Also known as thermal blanket for pallet, it was developed to
            protect palletized goods sensitive to temperature variation. They
            are produced according to the customer&apos;s need, in the measures
            that best fit their logistics operation. The thermal blanket for
            pallet, or thermal covering for pallet, or simply thermal blanket,
            is a viable solution for freight forwarders of perishable products,
            reducing the risk of temperature breakage and consequent loss and
      ...
      <div className="pt-8 text-center mb-8">
        <CardTitle className="text-3xl md:text-4xl font-bold pb-10">
          Benefits
        </CardTitle>
      ...
      <div className="flex items-center mt-8 justify-between gap-8 bg-slate-100">
        ...
        <div>
          <Image src={CoberturaTermica} alt="Image" width={300} height={500} />
        </div>
      </div>
      <div className="flex gap-5 mr-auto pl-8 pt-8 items-center ml-8">
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          ...
          <CardDescription className=" mb-8">
            For the coating, we use nylon, a easy to clean, waterproof and
