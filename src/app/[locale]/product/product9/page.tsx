import { CardComponentPrateleira } from '@/app/components/card'
...
export default function Page() {
  ...
  const numbers: DetailsInfoProps[] = [
    ...
    },
    {
      ...
      number: 3,
      description:
        'prevents temperature exchange between interior and exterior',
    },
    {
      id: 4,
      number: 4,
  ...
  const items: ItemsInfoProps[] = [
    {
      ...
      title: 'Perfect Fit',
      description:
        'They are manufactured to fit perfectly and to make it easy to move within the fridge compartment.',
    },
    {
      id: 2,
      title: 'Lightweight',
    ...
    },
    {
      ...
      title: 'Coating',
      description:
        'The coating is made with 530 micron nylon fabric, with fire-resistant treatment, fungicide, antibacterial agent.',
    },
  ]
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-center pt-5 mb-36">
        ...
        <Image width={300} src={divisoriaTermicaPrateleira} alt="Hero" />
      </div>

      <div className="flex items-start gap-5 mr-auto pl-8 pb-8">
        <Image
          src={DivisoriaTermicaPrateleiraInfo}
          width={300}
          alt="teste"
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          <CardTitle className="text-2xl md:text-2xl font-bold">
            THE DIVISIONAL THERMAL IS USED TO SEPARATE FROZEN, REFRIGERATED AND
            DRY LOADS IN REFRIGERATED VEHICLES. OPTIMIZE YOUR LOGISTICS BY
            TRANSPORTING MORE THAN ONE LOAD IN A SINGLE VEHICLE.
          </CardTitle>
          <CardDescription className="mt-2">
            Especially used by food distributors, with many stops for different
            deliveries during the trip. They are manufactured in detail for
            perfect fitting in the shelves of the fridge. Generally, this
            division comes together with the fridge, in the factory. However,
            with our engineering team, we can manufacture the division for any
            client in Brazil. For this model, however, the correct measurements
            are essential.
          </CardDescription>
        </div>
      </div>
