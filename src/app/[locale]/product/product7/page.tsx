  ...
  const items: ItemsInfoProps[] = [
    {
      ...
      title: 'Lightweight',
      description:
        'The mobile thermal divider is lightweight and easy to use and move, due to its structure and light-weight filling.',
    },
    {
      id: 2,
      title: 'Coating',
      description:
        'Our thermal divider is coated with flame-retardant non-woven fabric, with UV-blocking agents, antioxidants and fungicides, making it much more resistant.',
    },
    {
      id: 3,
      title: 'Customization',
      description:
        'In addition to the size, we can put central or lateral door, ventilation kit. The track can be on top or side, depending on what best suits you.',
    },
    {
      id: 4,
      title: 'Aluminum structure',
      description:
        'The big difference of our mobile thermal divider is the aluminum structure and the inox cart.',
    },
  ]
    ...
    <div className="w-full flex flex-col items-center justify-center">
      ...
      <div className="flex items-start gap-5 mr-auto pl-8 pb-8">
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          <CardTitle>
            The THERMAL DIVIDER is used to separate frozen, refrigerated and
            sealed loads in vehicles cooled. OPTIMIZE YOUR LOGISTICS BY
            TRANSPORTING MORE THAN ONE LOAD IN ONE VEHICLE.
          </CardTitle>
          <CardDescription className="mt-2">
            Structured in aluminum, it is mainly used in refrigerated bays, and
            is installed on a standard 3-meter track, giving flexibility in
            loading and unloading goods. This model can be fabricated with a
            door, ventilation kit, and with an upper or lateral track.
          </CardDescription>
        </div>
      </div>
      ...
      <div className="flex gap-5 mr-auto pl-8 pt-8 items-center ml-8">
        ...
        <div className="flex flex-col" style={{ maxWidth: '600px' }}>
          ...
          <CardDescription className="mt-2 mb-8">
            Model built with aluminum structure, light material that
            doesn&apos;t rust, and its structure is fixed to the vehicle through
            rails.
          </CardDescription>
          {numbers
